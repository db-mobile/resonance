...
export class ScriptConsolePanel {
    ...
    appendEntry(content, level, message, timestamp) {
        ...
        entry.innerHTML = `
            ...
            <span style="color: var(--text-tertiary); font-size: 11px; margin-left: 8px;">${timeStr}</span>
            <div style="margin-top: 4px; color: var(--text-secondary);">${this.escapeHtml(message)}</div>
        `;
