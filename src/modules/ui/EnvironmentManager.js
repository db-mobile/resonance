        ...
        dialogContent.innerHTML = `
            <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 20px; flex-wrap: wrap; gap: 12px;">
                ...
                <div style="display: flex; gap: 8px; flex-wrap: wrap;">
                    <button id="env-import-btn" class="env-toolbar-btn" title="Import Environments">
                    ...
                    <button id="env-export-all-btn" class="env-toolbar-btn" title="Export All Environments">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                            <path d="M21 15v4a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2v-4"></path>
            ...
            <div style="display: flex; gap: 16px; flex: 1; overflow: hidden;">
                ...
                <div style="flex: 0 0 250px; display: flex; flex-direction: column; border-right: 1px solid var(--border-light); padding-right: 16px;">
                    <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                        ...
                        <button id="env-create-btn" class="env-create-btn" title="Create New Environment">+</button>
                    </div>
                ...
                <div style="margin-bottom: 20px;">
                    <div style="display: flex; flex-direction: column; gap: 12px; margin-bottom: 16px;">
                        ...
                        <div style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
                            ...
                            <button id="env-delete-btn" class="env-action-btn env-danger-btn" title="Delete Environment">
                                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                    ...
                    <div style="margin-bottom: 16px;">
                        <div style="display: flex; justify-content: space-between; align-items: center; margin-bottom: 12px;">
                            ...
                            <button id="env-add-variable-btn" class="env-create-btn" title="Add Variable">+ Add</button>
                        </div>
